...
export const TRANSLATIONS: Record<string, Translations> = {
  ...
  nav_games: { en: "Games", dv: "ގޭމްތައް", hi: "गेम्स", bn: "গেমস" },
  nav_ranked: { en: "Ranked", dv: "ރޭންކްޑް", hi: "रैंक्ड", bn: "র‍্যাংকড" },
  ...
  nav_online: { en: "Online", dv: "އޮންލައިން", hi: "ऑनलाइन", bn: "অনলাইন" },
  ...
  home_welcomeBack: { en: "Welcome back, {name}", dv: "އަނބުރާ މަރުޙަބާ, {name}", hi: "वापसी पर स्वागत है, {name}", bn: "আবার স্বাগতম, {name}" },
  ...
  // Leaderboard redesign (components/leaderboard/*).
  leaderboard_heroSubtitle: {
    en: "Compete, climb the ranks and earn rewards.",
    dv: "ވާދަކޮށް، ރޭންކް މައްޗަށް އަރައި، އިނާމް ހޯއްދަވާ.",
    hi: "प्रतिस्पर्धा करें, रैंक चढ़ें और पुरस्कार जीतें।",
    bn: "প্রতিদ্বন্দ্বিতা করুন, র‍্যাংক বাড়ান এবং পুরস্কার জিতুন।",
  },
  leaderboard_howItWorks: { en: "How it works?", dv: "މިކަން ހިނގާ ގޮތް؟", hi: "यह कैसे काम करता है?", bn: "এটি কীভাবে কাজ করে?" },
  leaderboard_refresh: { en: "Refresh leaderboard", dv: "ލީޑަރބޯޑް ރިފްރެޝްކުރޭ", hi: "लीडरबोर्ड रिफ्रेश करें", bn: "লিডারবোর্ড রিফ্রেশ করুন" },
  leaderboard_periodLabel: { en: "Ranking period", dv: "ރޭންކިންގް މުއްދަތު", hi: "रैंकिंग अवधि", bn: "র‍্যাংকিং সময়কাল" },
  leaderboard_tabWeekly: { en: "Weekly", dv: "ހަފުތާ", hi: "साप्ताहिक", bn: "সাপ্তাহিক" },
  leaderboard_tabMonthly: { en: "Monthly", dv: "މަހު", hi: "मासिक", bn: "মাসিক" },
  leaderboard_tabAllTime: { en: "All Time", dv: "ހުރިހާ ދުވަހެއް", hi: "सर्वकालिक", bn: "সর্বকালীন" },
  leaderboard_tabFriends: { en: "Friends", dv: "ރަޙްމަތްތެރިން", hi: "दोस्त", bn: "বন্ধুরা" },
  leaderboard_comingSoon: { en: "Coming soon", dv: "ވަރަށް އަވަހަށް", hi: "जल्द आ रहा है", bn: "শীঘ্রই আসছে" },
  leaderboard_resetsIn: { en: "Resets in {time}", dv: "{time} ތެރޭ ރީސެޓްވޭ", hi: "{time} में रीसेट", bn: "{time} পরে রিসেট" },
  leaderboard_you: { en: "You", dv: "ތިބާ", hi: "आप", bn: "আপনি" },
  leaderboard_yourRank: { en: "Your Rank", dv: "ތިބާގެ ރޭންކް", hi: "आपकी रैंक", bn: "আপনার র‍্যাংক" },
  leaderboard_unranked: { en: "Unranked", dv: "ރޭންކެއް ނެތް", hi: "अनरैंक्ड", bn: "র‍্যাংকবিহীন" },
  leaderboard_unrankedHint: {
    en: "Play ranked matches to enter the leaderboard.",
    dv: "ލީޑަރބޯޑަށް ވަނުމަށް ރޭންކްޑް މެޗް ކުޅުއްވާ.",
    hi: "लीडरबोर्ड में आने के लिए रैंक्ड मैच खेलें।",
    bn: "লিডারবোর্ডে ঢুকতে র‍্যাংকড ম্যাচ খেলুন।",
  },
  leaderboard_keepPlaying: { en: "Keep playing to climb higher.", dv: "މައްޗަށް އެރުމަށް ކުޅުން ކުރިއަށް ގެންދަވާ.", hi: "ऊपर चढ़ने के लिए खेलते रहें।", bn: "উপরে উঠতে খেলা চালিয়ে যান।" },
  leaderboard_gapToNext: { en: "{n} trophies to the next place.", dv: "ދެން އޮތް ވަނައަށް {n} ޓްރޮފީ.", hi: "अगले स्थान तक {n} ट्रॉफी।", bn: "পরের স্থানে যেতে {n} ট্রফি।" },
  leaderboard_climbLabel: { en: "Progress to the next place", dv: "ދެން އޮތް ވަނައަށް ކުރިއެރުން", hi: "अगले स्थान तक प्रगति", bn: "পরের স্থানে অগ্রগতি" },
  leaderboard_weeklyRewards: { en: "Weekly Rewards", dv: "ހަފުތާގެ އިނާމް", hi: "साप्ताहिक पुरस्कार", bn: "সাপ্তাহিক পুরস্কার" },
  leaderboard_rewardsByTier: {
    en: "Paid by rank tier, not placement.",
    dv: "ދެވެނީ ރޭންކް ޓިއަރ އަށް، ވަނައަކަށް ނޫން.",
    hi: "स्थान नहीं, रैंक टियर के अनुसार।",
    bn: "স্থান নয়, র‍্যাংক টিয়ার অনুযায়ী।",
  },
  leaderboard_player: { en: "Player", dv: "ކުޅުންތެރިޔާ", hi: "खिलाड़ी", bn: "খেলোয়াড়" },
  leaderboard_matches: { en: "Matches", dv: "މެޗް", hi: "मैच", bn: "ম্যাচ" },
  leaderboard_wins: { en: "Wins", dv: "މޮޅު", hi: "जीत", bn: "জয়" },
  leaderboard_winRate: { en: "Win Rate", dv: "މޮޅުވި ނިސްބަތް", hi: "जीत दर", bn: "জয়ের হার" },
  leaderboard_trophies: { en: "Trophies", dv: "ޓްރޮފީ", hi: "ट्रॉफी", bn: "ট্রফি" },
  leaderboard_tableCaption: { en: "Player rankings", dv: "ކުޅުންތެރިންގެ ރޭންކިންގް", hi: "खिलाड़ी रैंकिंग", bn: "খেলোয়াড় র‍্যাংকিং" },
  leaderboard_searchLabel: { en: "Search rankings", dv: "ރޭންކިންގްގައި ހޯއްދަވާ", hi: "रैंकिंग खोजें", bn: "র‍্যাংকিং খুঁজুন" },
  leaderboard_searchPlaceholder: { en: "Search players…", dv: "ކުޅުންތެރިން ހޯއްދަވާ…", hi: "खिलाड़ी खोजें…", bn: "খেলোয়াড় খুঁজুন…" },
  leaderboard_noMatches: { en: "No players match your search.", dv: "ހޯއްދެވި ގޮތާ ގުޅޭ ކުޅުންތެރިއެއް ނެތް.", hi: "आपकी खोज से कोई खिलाड़ी मेल नहीं खाता।", bn: "আপনার খোঁজের সাথে কোনো খেলোয়াড় মেলেনি।" },
  leaderboard_emptyTitle: { en: "No ranked players yet.", dv: "އަދި ރޭންކްޑް ކުޅުންތެރިއެއް ނެތް.", hi: "अभी तक कोई रैंक्ड खिलाड़ी नहीं।", bn: "এখনো কোনো র‍্যাংকড খেলোয়াড় নেই।" },
  leaderboard_emptyBody: {
    en: "Play ranked matches to be the first on the board.",
    dv: "ބޯޑުގެ ފުރަތަމަ ކުޅުންތެރިޔާ ވުމަށް ރޭންކްޑް މެޗް ކުޅުއްވާ.",
    hi: "बोर्ड पर पहले बनने के लिए रैंक्ड मैच खेलें।",
    bn: "বোর্ডে প্রথম হতে র‍্যাংকড ম্যাচ খেলুন।",
  },
  leaderboard_emptyFriends: { en: "No friends are ranked yet.", dv: "އަދި ރޭންކްވެފައިވާ ރަޙްމަތްތެރިއެއް ނެތް.", hi: "अभी तक कोई दोस्त रैंक्ड नहीं है।", bn: "এখনো কোনো বন্ধু র‍্যাংকড নয়।" },
  leaderboard_findFriends: { en: "Find Friends", dv: "ރަޙްމަތްތެރިން ހޯއްދަވާ", hi: "दोस्त खोजें", bn: "বন্ধু খুঁজুন" },
  leaderboard_hiwOrderTitle: { en: "How ranks are ordered", dv: "ރޭންކް ތަރުތީބުކުރެވޭ ގޮތް", hi: "रैंक कैसे क्रमबद्ध होती है", bn: "র‍্যাংক কীভাবে সাজানো হয়" },
  leaderboard_hiwOrderBody: {
    en: "Players are ordered by trophies, highest first. The weekly board counts only trophies earned since Monday; All Time counts your lifetime total.",
    dv: "ކުޅުންތެރިން ތަރުތީބުކުރެވެނީ ޓްރޮފީއަށް، އެންމެ މަތިން ފެށިގެން. ހަފުތާ ބޯޑުގައި ގުނަނީ ހޯމަދުވަހުން ފެށިގެން ހޯދި ޓްރޮފީ އެކަނި.",
    hi: "खिलाड़ी ट्रॉफी के अनुसार क्रमबद्ध होते हैं, सबसे अधिक पहले। साप्ताहिक बोर्ड केवल सोमवार से अर्जित ट्रॉफी गिनता है।",
    bn: "খেলোয়াড়দের ট্রফি অনুযায়ী সাজানো হয়, সর্বোচ্চ প্রথমে। সাপ্তাহিক বোর্ড কেবল সোমবার থেকে অর্জিত ট্রফি গণনা করে।",
  },
  leaderboard_hiwTrophyTitle: { en: "What trophies mean", dv: "ޓްރޮފީގެ މާނަ", hi: "ट्रॉफी का अर्थ", bn: "ট্রফির অর্থ" },
  leaderboard_hiwTrophyBody: {
    en: "Ranked wins add trophies and losses subtract them. Your tier — Bronze, Silver, Gold or Platinum — follows your lifetime total.",
    dv: "ރޭންކްޑް މޮޅުވުމުން ޓްރޮފީ އިތުރުވެ، ބަލިވުމުން މަދުވޭ. ތިބާގެ ޓިއަރ ބިނާވަނީ ޖުމްލަ ޓްރޮފީއަށް.",
    hi: "रैंक्ड जीत ट्रॉफी जोड़ती है और हार घटाती है। आपका टियर आपके कुल ट्रॉफी पर निर्भर करता है।",
    bn: "র‍্যাংকড জয় ট্রফি যোগ করে এবং হার বিয়োগ করে। আপনার টিয়ার নির্ভর করে মোট ট্রফির উপর।",
  },
  leaderboard_hiwResetTitle: { en: "Weekly reset", dv: "ހަފުތާގެ ރީސެޓް", hi: "साप्ताहिक रीसेट", bn: "সাপ্তাহিক রিসেট" },
  leaderboard_hiwResetBody: {
    en: "The week turns over at midnight on Monday. Your weekly count clears the next time you play after that, so it is not wiped while you are away.",
    dv: "ހަފުތާ ބަދަލުވަނީ ހޯމަދުވަހުގެ މެންދަމު. ތިބާގެ ހަފުތާ ގުނުން ސުމަކަށް ދަނީ އެއަށްފަހު ދެން ކުޅޭ ފަހަރު.",
    hi: "सप्ताह सोमवार आधी रात को बदलता है। आपकी साप्ताहिक गिनती उसके बाद अगली बार खेलने पर साफ होती है।",
    bn: "সপ্তাহ সোমবার মধ্যরাতে পাল্টায়। আপনার সাপ্তাহিক গণনা এরপর পরের বার খেললে মুছে যায়।",
  },
  leaderboard_hiwRewardTitle: { en: "Reward eligibility", dv: "އިނާމަށް ޝަރުޠުހަމަވުން", hi: "पुरस्कार पात्रता", bn: "পুরস্কারের যোগ্যতা" },
  leaderboard_hiwRewardBody: {
    en: "Weekly coins are paid by your rank tier rather than your position on the board, so climbing a tier is what increases the payout.",
    dv: "ހަފުތާގެ ކޮއިން ދެވެނީ ބޯޑުގެ ވަނައަކަށް ނޫން، ރޭންކް ޓިއަރ އަށް.",
    hi: "साप्ताहिक सिक्के बोर्ड पर आपकी स्थिति के बजाय आपके रैंक टियर के अनुसार दिए जाते हैं।",
    bn: "সাপ্তাহিক কয়েন বোর্ডের অবস্থান নয়, আপনার র‍্যাংক টিয়ার অনুযায়ী দেওয়া হয়।",
  },
  common_close: { en: "Close", dv: "ބަންދުކުރޭ", hi: "बंद करें", bn: "বন্ধ করুন" },
  ...
  friends_loadError: { en: "Couldn't load your friends right now.", dv: "ރަޙްމަތްތެރިން ލޯޑް ނުވިއެވެ.", hi: "अभी दोस्तों को लोड नहीं किया जा सका।", bn: "এই মুহূর্তে বন্ধুদের লোড করা যায়নি।" },
  friends_message: { en: "Message", dv: "މެސެޖް", hi: "संदेश", bn: "বার্তা" },
  friends_remove: { en: "Remove", dv: "ނަގާ", hi: "हटाएं", bn: "সরান" },
  friends_inGame: { en: "In Game", dv: "ގޭމުގައި", hi: "गेम में", bn: "গেমে" },
  friends_noneYet: { en: "No friends yet", dv: "އަދި ރަޙްމަތްތެރިއެއް ނެތް", hi: "अभी तक कोई दोस्त नहीं", bn: "এখনো কোনো বন্ধু নেই" },
  friends_requests: { en: "Friend requests", dv: "ރަޙްމަތްތެރިކަމުގެ ރިކުއެސްޓް", hi: "मित्र अनुरोध", bn: "বন্ধুত্বের অনুরোধ" },
  ...
  clubs_loadError: { en: "Couldn't load clubs.", dv: "ކްލަބް ލޯޑް ނުވިއެވެ.", hi: "क्लब लोड नहीं हो सका।", bn: "ক্লাব লোড করা যায়নি।" },
  ...
  messages_loadError: { en: "Couldn't load your conversations.", dv: "ވާހަކަތައް ލޯޑް ނުވިއެވެ.", hi: "बातचीत लोड नहीं हो सकी।", bn: "কথোপকথন লোড করা যায়নি।" },
  ...
  common_loadMatchError: { en: "Couldn't load this match.", dv: "މެޗް ލޯޑް ނުވިއެވެ.", hi: "यह मैच लोड नहीं हो सका।", bn: "এই ম্যাচটি লোড করা যায়নি।" },
  ...
  vip_pitch: {
    en: "Unlock exclusive rewards, extra ranked matches and premium benefits.",
    dv: "ޚާއްޞަ އިނާމްތަކާއި، އިތުރު ރޭންކްޑް މެޗްތަކާއި ޕްރީމިއަމް ބެނިފިޓްސް ފަހިކުރޭ.",
    hi: "विशेष रिवॉर्ड्स, अतिरिक्त रैंक्ड मैच और प्रीमियम लाभ अनलॉक करें।",
  ...
  home_popularModes: { en: "Popular Modes", dv: "މަޤްބޫލް މޯޑްތައް", hi: "लोकप्रिय मोड", bn: "জনপ্রিয় মোড" },
  search_placeholder: { en: "Search games, modes...", dv: "ގޭމް، މޯޑް ހޯދާ...", hi: "गेम्स, मोड खोजें...", bn: "গেমস, মোড খুঁজুন..." },
  search_noResults: { en: "No matches found", dv: "ނުފެނުނު", hi: "कोई परिणाम नहीं", bn: "কোনো ফলাফল নেই" },
  ...
  home_heroBadgePlay: { en: "Featured", dv: "ފީޗާޑް", hi: "फ़ीचर्ड", bn: "ফিচার্ড" },
  home_heroCategory: { en: "The Home of Maldivian Card Games", dv: "ދިވެހި ކާޑް ގޭމް", hi: "मालदीव कार्ड गेम्स का घर", bn: "মালদ্বীপের কার্ড গেমের ঘর" },
  home_heroTagline: { en: "Jump into Mindi or Gin Rummy and climb the ranks.", dv: "މިންޑި ނުވަތަ ޖިން ރަމީ ކުޅެ ރޭންކް މަތިކުރޭ.", hi: "मिंडी या जिन रम्मी में शामिल हों और रैंक बढ़ाएं।", bn: "মিন্ডি বা জিন রামিতে যোগ দিন এবং র‍্যাংক বাড়ান।" },
  home_heroBadgeLive: { en: "LIVE", dv: "ލައިވް", hi: "लाइव", bn: "লাইভ" },
  home_heroBadgeEvent: { en: "EVENT", dv: "އިވެންޓް", hi: "इवेंट", bn: "ইভেন্ট" },
  home_heroCategoryEvent: { en: "Double Trophies · Fri – Sat", dv: "ދެގުނަ ތަށި · ހުކުރު - ހޮނިހިރު", hi: "दोगुनी ट्रॉफी · शुक्र-शनि", bn: "দ্বিগুণ ট্রফি · শুক্র-শনি" },
  home_enterLeague: { en: "Enter League", dv: "ލީގަށް ވަދޭ", hi: "लीग में शामिल हों", bn: "লিগে প্রবেশ করুন" },
  ...
  roomlobby_loadError: { en: "Couldn't load this room.", dv: "ރޫމް ލޯޑް ނުވިއެވެ.", hi: "यह रूम लोड नहीं हो सका।", bn: "এই রুমটি লোড করা যায়নি।" },
  roomlobby_notFound: { en: "This room doesn't exist, or the code is wrong.", dv: "މި ރޫމް ނެތް، ނުވަތަ ކޯޑް ގޯސް.", hi: "यह रूम मौजूद नहीं है, या कोड गलत है।", bn: "এই রুমের অস্তিত্ব নেই, অথবা কোডটি ভুল।" },
  ...
  spectate_notFound: { en: "This match has ended or isn't available anymore.", dv: "މި މެޗް ނިމިއްޖެ ނުވަތަ މިހާރު ނެތް.", hi: "यह मैच समाप्त हो गया है या अब उपलब्ध नहीं है।", bn: "এই ম্যাচটি শেষ হয়ে গেছে বা আর উপলব্ধ নেই।" },
  spectate_loadError: { en: "Couldn't load this match.", dv: "މެޗް ލޯޑް ނުވިއެވެ.", hi: "यह मैच लोड नहीं हो सका।", bn: "এই ম্যাচটি লোড করা যায়নি।" },
  ...
  // Achievements redesign (components/achievements/*).
  ach_heroSubtitle: {
    en: "Complete milestones, unlock rewards and show off your progress.",
    dv: "މޭލްސްޓޯންތައް ފުރިހަމަކޮށް، އިނާމް ހޯދައި، ކުރިއެރުން ދައްކާލައްވާ.",
    hi: "मील के पत्थर पूरे करें, पुरस्कार अनलॉक करें और अपनी प्रगति दिखाएं।",
    bn: "মাইলফলক সম্পূর্ণ করুন, পুরস্কার আনলক করুন এবং অগ্রগতি দেখান।",
  },
  ach_overallTitle: { en: "Overall Progress", dv: "ޖުމްލަ ކުރިއެރުން", hi: "समग्र प्रगति", bn: "সামগ্রিক অগ্রগতি" },
  ach_overallSubtitle: { en: "Complete achievements to earn rewards", dv: "އިނާމް ހޯދުމަށް ހާސިލްކުރުންތައް ފުރިހަމަކުރައްވާ", hi: "पुरस्कार पाने के लिए उपलब्धियां पूरी करें", bn: "পুরস্কার পেতে অর্জন সম্পূর্ণ করুন" },
  ach_completedCaption: { en: "Achievements completed", dv: "ފުރިހަމަކުރެވުނު ހާސިލްކުރުންތައް", hi: "पूरी हुई उपलब्धियां", bn: "সম্পন্ন অর্জন" },
  ach_categoryLabel: { en: "Achievement category", dv: "ހާސިލްކުރުމުގެ ބާވަތް", hi: "उपलब्धि श्रेणी", bn: "অর্জনের বিভাগ" },
  ach_catAll: { en: "All", dv: "ހުރިހާ", hi: "सभी", bn: "সব" },
  ach_catGameplay: { en: "Gameplay", dv: "ކުޅުން", hi: "गेमप्ले", bn: "গেমপ্লে" },
  ach_catRanks: { en: "Ranks", dv: "ރޭންކް", hi: "रैंक", bn: "র‍্যাংক" },
  ach_catCollections: { en: "Collections", dv: "ކަލެކްޝަން", hi: "संग्रह", bn: "সংগ্রহ" },
  ach_catSpecial: { en: "Special", dv: "ޚާއްޞަ", hi: "विशेष", bn: "বিশেষ" },
  ach_locked: { en: "Locked", dv: "ތަޅުލެވިފައި", hi: "लॉक्ड", bn: "লকড" },
  ach_unlocked: { en: "Unlocked", dv: "އަންލޮކް", hi: "अनलॉक्ड", bn: "আনলকড" },
  ach_rewardCoins: { en: "Reward Coins", dv: "އިނާމް ކޮއިން", hi: "रिवॉर्ड सिक्के", bn: "পুরস্কার কয়েন" },
  ach_prestige: { en: "Prestige", dv: "ޝަރަފު", hi: "प्रतिष्ठा", bn: "সম্মান" },
  ach_progressLabel: { en: "progress", dv: "ކުރިއެރުން", hi: "प्रगति", bn: "অগ্রগতি" },
  ach_rewardTooltip: {
    en: "Granted automatically when this achievement unlocks.",
    dv: "މި ހާސިލްކުރުން އަންލޮކްވުމުން އަމިއްލައަށް ލިބޭ.",
    hi: "यह उपलब्धि अनलॉक होने पर स्वतः मिलता है।",
    bn: "এই অর্জন আনলক হলে স্বয়ংক্রিয়ভাবে দেওয়া হয়।",
  },
  ach_emptyCategory: { en: "No achievements in this category yet.", dv: "މި ބާވަތުގައި އަދި ހާސިލްކުރުމެއް ނެތް.", hi: "इस श्रेणी में अभी कोई उपलब्धि नहीं।", bn: "এই বিভাগে এখনো কোনো অর্জন নেই।" },
  ...
  mindi_haasbaga: { en: "Haas Baga — all 4 Tens and every trick!", dv: "ހާސް ބަގާ — 4 ޓެންއާއި ހުރިހާ ރައުންޑެއް!", hi: "हास बागा — सभी 4 टेंस और हर राउंड!", bn: "হাস বাগা — সব ৪টি টেন এবং প্রতিটি রাউন্ড!" },
  mindi_noTrump: { en: "No trump yet", dv: "އަދި ޓްރަމްޕެއް ނެތް", hi: "अभी कोई ट्रम्प नहीं", bn: "এখনও কোনো ট্রাম্প নেই" },
