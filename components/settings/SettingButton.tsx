    ...
    >
      <div className="flex items-center gap-3">
        <div className={`w-9 h-9 rounded-xl flex items-center justify-center ${
          danger ? "bg-[rgb(var(--coral)/10%)]" : "bg-[rgb(var(--c2))]"
        }`}>
          <Icon size={18} className={danger ? "text-[rgb(var(--coral-ink))]" : "text-[rgb(var(--c4))] group-hover:text-[rgb(var(--gold-ink))]"} />
        </div>
      ...
      <ChevronRight size={16} className="text-[rgb(var(--c3))] group-hover:text-[rgb(var(--gold-ink))] transition-colors" />
    </motion.button>
  );
}
