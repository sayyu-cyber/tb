...
function TimeUnit({ value, label }: { value: number; label: string }) {
  return (
    <div className="flex flex-col items-center">
      ...
      >
        <span className="text-2xl font-bold text-[rgb(var(--gold-ink))]">
  ...
  if (isExpired) {
    return (
      <div className="text-center py-4">
        <p className="text-[rgb(var(--gold-ink))] font-semibold">Event has started!</p>
      </div>
    );
  }
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex items-center justify-center gap-3">
        ...
        <span className="text-[rgb(var(--gold-ink))] text-2xl font-light -mt-4">:</span>
