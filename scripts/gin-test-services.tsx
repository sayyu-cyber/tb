...
export const useEconomy=()=>({state:{economy:{coins:100},profile:{equipped:{tableTheme:location.search.includes("red")?"tt_red":"tt_default",cardBack:"cb_neon"}}},processMatchEnd:()=>{}});
